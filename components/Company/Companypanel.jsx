    ...
    return (
        <div>
            <div className='bg-gray-950 h-[100%] w-[15vw] md:w-[9vw] lg:w-[20vw] xl:w-[18vw] flex flex-col gap-6 xl:gap-8 items-center pt-20 lg:pt-10'>
                ...
                <NavLink to={'/company/login'} className={e => { return e.isActive ? "text-red-500" : "text-red-500" }} onClick={handlelogout}><div className=' font-bold flex lg:w-[14vw] xl:w-[17vw] bg-gray-900 p-3 xl:py-2 xl:px-9 rounded-full lg:rounded-xl items-center  hover:bg-gray-800 gap-2 xl:gap-4 '><IoLogOutOutline size={32} /><div className='hidden lg:block lg:text-md xl:text-xl'>Logout</div></div></NavLink>
            </div>
        </div>
    )
}
