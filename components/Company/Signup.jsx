    ...
    return (
        <>
            ...
            <div className='w-full h-screen bg-gray-100 flex  justify-center items-center select-none'>
                <div className='bg-white w-[100vw] h-screen lg:w-[40vw] md:w-[60vw] md:h-auto md:shadow-xl p-4 pt-15 rounded-xl'>
                    ...
                    <form action="" onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-3 md:gap-2 mt-10'>
                        ...
                        <label htmlFor="Email" className='font-medium text-xl mt-2'>Email</label>
                        ...
                        <label htmlFor="Address" className='font-medium text-xl mt-2'>Address</label>
                        ...
                        <label htmlFor="Phonenumber" className='font-medium text-xl mt-2'>Phone Number</label>
